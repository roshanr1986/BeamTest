...
========================
You can change test parameters used in the scenario description by changing the data within double quotation in each stap as required. To change, please edit "src\test\java\Features\AmazonShoppingCart.feature" file and save.
